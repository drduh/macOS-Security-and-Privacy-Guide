...
| --- | --- | --- | --- |
| Family | See private chats or browsing history | Close proximity; can see screen or watch me type in password | Use biometrics, use privacy screen, keep phone locked when not using it |
...
| Nation State | Targeted surveillance | Passive surveillance of internet infrastructure, advanced computers for cracking encryption/analysis of packets | Always use encryption for all connections |
